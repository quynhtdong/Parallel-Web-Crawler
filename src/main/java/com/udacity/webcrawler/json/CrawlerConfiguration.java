...
public final class CrawlerConfiguration {
  ...
  public String toString() {
    return "CrawlerConfiguration{" +
            ...
            ", ignoreUrls=" + getIgnoredUrls() +
            ", ignoreWords" + getIgnoredWords() +
            ", parallelism" + getParallelism() +
            ", implementationOverride" + getImplementationOverride() +
            ", maxDepth" + getMaxDepth() +
            ", timeoutSeconds" + getTimeout() +
            ", popularWordCount" + getPopularWordCount() +
            ", profileOutputPath" + getProfileOutputPath() +
